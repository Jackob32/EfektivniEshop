...
import {Dropdown, DropdownItem, DropdownMenu, Progress} from 'reactstrap';
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        ...
                                        <ul className="horizontal-bars type-2">
                                            ...
                                            <li>
                                                ...
                                                <span className="value">191,235 <span
                                            ...
                                            <li>
                                                ...
                                                <span className="value">51,223 <span
                                            ...
                                            <li>
                                                ...
                                                <span className="value">37,564 <span
                                            ...
                                            <li>
                                                ...
                                                <span className="value">27,319 <span
                                            ...
                                            <li className="divider text-center">
                                                <button type="button" className="btn btn-sm btn-link text-muted"
                                                        ...
                                                        data-original-title="show more"><i className="icon-options"></i>
                                                </button>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul className="icons-list">
                                            <li>
                                                ...
                                                <div className="actions">
                                                    <button type="button" className="btn btn-link text-muted"><i
