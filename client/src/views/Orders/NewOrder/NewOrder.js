...
import {change, Field, FormSection, formValueSelector, reduxForm, touched} from 'redux-form'
...
class NewOrder extends Component {
    ...
    render() {
        ...
        return (
            <ChangeForm submitModifier={this.submitModifier}  {...this.props} redirect="/orders/"
                        id={this.props.match.params.id} updateheadline="Upravit Objednávku"
                        newheadline="Nová Objednávka" url="/api/orders" formname="NewOrderForm">

                <div id="react-no-print">
                    <a className="btn btn-default" href="javascript:window.print()"
                       onMouseEnter={() => (this.setState({print: "order"}))}>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            {products &&
                            <FilterTable formname='NewOrderForm' simple={true} dispatch={this.props.dispatch}
