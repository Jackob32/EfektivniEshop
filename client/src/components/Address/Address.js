                    ...
                    <div className="card-block">
                        ...
                        <div className="card-block">
                            <div className={this.state.collapse === true ? 'hidden' : ''}>
                                <div className="row">
                                    <Field name="firstname" label="" show={this.state.show} component={Input}
                                           type="text"/>
                                    &nbsp;
                                    <Field name="lastname" label="" show={this.state.show} component={Input}
                                           type="text"/>
                                </div>

                                <div className="row">
                                    <Field name="phone" label="" show={this.state.show} component={Input} type="text"/>
                                </div>
                                <div className="row"><Field name="company" label="" show={this.state.show}
            ...
            return <div className="col-sm-12 col-md-12 col-lg-6">
                <div className="card">
                    <div className="card-header">
                        {this.state.name}{" "}
                        {this.state.onstart}{" "}
                        {this.state.dorucovaci &&
                        <Field name="same" label="Stejná Jako Fakturační" component="input" type="checkbox"/>}

                        <div className="card-actions">

                            <a href="#" className="btn-minimize" onClick={this.toggleShow}><i
                        ...
                        <div className={this.state.collapse === true ? 'hidden' : ''}>
                            ...
                            <div className="row">
                                <div className="col-sm-6 col-md-6 col-lg-6">
                                    <Field name="firstname" label="Jméno" show={this.state.show} component={Input}
                                           type="text"/>
                                </div>
                                <div className="col-sm-6 col-md-6 col-lg-6">
                                    <Field name="lastname" label="Příjmení" show={this.state.show} component={Input}
                                           type="text"/>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-sm-6 col-md-6 col-lg-6">
                                    <Field name="phone" label="Telefon" show={this.state.show} component={Input}
                                           type="text"/>
                                </div>
                                <div className="col-sm-6 col-md-6 col-lg-6">
                                    <Field name="company" label="Firma" show={this.state.show} component={Input}
                                           type="text"/>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-sm-6 col-md-6 col-lg-6">
                                    <Field name="street" label="Ulice" show={this.state.show} component={Input}
                                           type="text"/>
                                </div>
                                <div className="col-sm-6 col-md-6 col-lg-6">
                                    <Field name="number" label="Číslo domu" show={this.state.show} component={Input}
                                           type="number"/>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-sm-6 col-md-6 col-lg-6">
                                    <Field name="district" label="Okres" show={this.state.show} component={Input}
                                           type="text"/>
                                </div>
                                <div className="col-sm-6 col-md-6 col-lg-6">
                                    <Field name="city" label="Město" show={this.state.show} component={Input}
                                           type="text"/>
                                </div>
                            </div>
                            <div className="row">
                                ...
                                <div className="col-sm-6 col-md-6 col-lg-6">
                                    <Field name="country" label="Země" show={this.state.show} component={Input}
                                           type="text"/>
                                </div>
                            </div>
